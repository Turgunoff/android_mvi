package com.myapp.android_mvi.adapter
...
import com.myapp.android_mvi.activity.MainActivity
import com.myapp.android_mvi.model.Post
import com.myapp.android_mvi.utils.Utils
import java.util.*
...
class PostAdapter(var activity: MainActivity, var items: ArrayList<Post>) :
    ...
    private fun deletePostDialog(post: Post): Boolean {
        val title = "Delete"
